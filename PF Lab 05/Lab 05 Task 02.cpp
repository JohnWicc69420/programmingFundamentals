...
// we again use the while loop so that the entered value can be easuly reversed and then we will add the previous sum to the next number and re define the number by dividing it with 10. The loop will continue until all the numbers are
// done being reversed
